...
func main() {
	...
	mux.Handle("/v1/orders/get", jwts.AuthMiddleware(createProxyHandler(orderProxy)))
	mux.Handle("/v1/orders/update", jwts.AuthMiddleware(createProxyHandler(orderProxy)))
